...
<div><h4>미로2</h4>
Queue 개념이 헷갈려서 복습용으로 다시 풀어본 문제.
queue를 쓰려다가 -> deque을 쓰려다가 -> heapq 라이브러리 밖에 생각이 안나서 활용해보려다가 -> 결국 마무리 못했던 문제.
heapq에 대한 개념도 희미해져있어서 다시 정리했다.
우선순위 큐, 일반 덱과 큐에 대해서 다시 짚고 넘어갈 수 있었던 문제였고, BFS나 이후 다른 알고리즘을 이해하는 데에 큰 도움이 될 것이다.
